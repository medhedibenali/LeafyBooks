// @flow
import type { Modifier, ModifierArguments, Padding, Rect } from '@popperjs/core/lib/types';
...
import { left, right, basePlacements, top, bottom } from '@popperjs/core/lib/enums';
