                            ...
                            <div id="<?= 'carouselExampleIndicators' . $indice ?>" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner2">
                                    <div class="carousel-item active">
                                        <a href="book-page.php?isbn=<?= ($images[$key][0])->isbn ?>">
                                            <img class="d-block w-100" src="      <?= 'img/books/'. ($images[$key][0])->image ?>   " alt="First slide" id="f1">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a href="book-page.php?isbn=<?= ($images[$key][1])->isbn ?>">
                                            <img class="d-block w-100" src="<?= 'img/books/'. ($images[$key][1])->image ?>" alt="Second slide" id="f2">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a href="book-page.php?isbn=<?= ($images[$key][2])->isbn ?>">
                                            <img class="d-block w-100" src="<?= 'img/books/'. ($images[$key][2])->image ?>" alt="Third slide" id="f3">
                                        </a>
                                    </div>
                                </div>
